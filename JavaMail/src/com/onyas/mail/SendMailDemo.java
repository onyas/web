	...
	public void sendMail() throws Exception{
		...
		Authenticator auth = new Authenticator() {
			...
			public PasswordAuthentication getPasswordAuthentication() {
				PasswordAuthentication pa = //发件人的用户名与密码
						new PasswordAuthentication("hr", "hr");
				return pa;
			}
		};
		////第二步：获取Session对象
		...
		//第四步：设置发件人email
		Address from = new InternetAddress("hr@qq.com");
		mm1.setFrom(from);
		//第五步：设置收件人
		mm1.setRecipient(RecipientType.TO,new InternetAddress("zheng0518@sina.cn"));
